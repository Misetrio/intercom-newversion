...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'isis' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'isis' ),
		'repeat-y'  => __( 'Repeat Vertically', 'isis' ),
		'repeat'    => __( 'Repeat All', 'isis' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'isis' ),
		'top center'    => __( 'Top Center', 'isis' ),
		'top right'     => __( 'Top Right', 'isis' ),
		'center left'   => __( 'Middle Left', 'isis' ),
		'center center' => __( 'Middle Center', 'isis' ),
		'center right'  => __( 'Middle Right', 'isis' ),
		'bottom left'   => __( 'Bottom Left', 'isis' ),
		'bottom center' => __( 'Bottom Center', 'isis' ),
		'bottom right'  => __( 'Bottom Right', 'isis')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'isis' ),
		'fixed'  => __( 'Fixed in Place', 'isis')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'isis' ),
		'italic'      => __( 'Italic', 'isis' ),
		'bold'        => __( 'Bold', 'isis' ),
		'bold italic' => __( 'Bold Italic', 'isis' )
		);
