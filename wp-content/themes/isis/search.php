...
<div class="search_term"><h2 class="postsearch"><?php printf( __( 'Search Results for: %s', 'isis' ), get_search_query() ); ?></h2>
            
      <a class="search_count"><?php _e('Total posts found for', 'isis'); ?> <?php /* Search Count */ $allsearch = new WP_Query("s=$s&showposts=-1"); $key = esc_html($s, 1); $count = $allsearch->post_count; _e('', 'isis'); _e('<span class="search-terms">"', 'isis'); echo $key; _e('"</span>', 'isis'); _e(' &mdash; ', 'isis'); echo $count . ''; wp_reset_query(); ?></a>
            <?php get_search_form(); ?>        
            </div>
...
<div id="content" class="content_blog blog_style_b1" role="main">
					...
					<article class="post_format_standard odd">
						...
						<div class="post_content">
							<p><?php the_content(); ?></p>
							<div class="readmore"><a href="<?php the_permalink();?>" class="more-link"><?php echo esc_attr__('Read more','isis');?></a></div>
						</div>
