 ...
 <div id="nivo" class="nivoSlider" style="height: 500px;">
                
                
                
                <img title="#nv_1" style="display:block;" src="<?php echo get_template_directory_uri(); ?>/images/slide1.jpg"  alt="" data-transition="slideInLeft" />
				 <img title="#nv_2" src="<?php echo get_template_directory_uri(); ?>/images/demo/slide1.jpg"  alt="" data-transition="slideInLeft" />
                
                <a href="<?php echo esc_url( home_url( '/' ) );?>"><img src="<?php echo get_template_directory_uri(); ?>/images/slides/slide1.jpg" alt="You can also add Links to your slides" title="#nv_3"/></a>
