...
$numberfront_array = array("1" => "One","2" => "Two","3" => "Three","4" => "Four","5" => "Five", "6" => "Six","7" => "Seven","8" => "Eight","9" => "Nine","10" => "Ten","11" => "Eleven", "12" => "Twelve");
	...
	$options[] = array(
		...
		'desc' => __('<b>Upgrade to Isis PRO for more 4 Layouts and 4 header layout </b>', 'isis'),
		'type' => 'info');
...
$options[] = array( "name" => __('Custom logo image', 'isis'),
	...
	$options[] = array(
		...
		'desc' => __('<b>Upgrade to Isis PRO for 22 awesome fonts and Unlimited Skins- Ability to change the color of any elements </b>', 'isis'),
		'type' => 'info');
...
$options[] = array(
	...
	$options[] = array(
		'desc' => __('Description or Tagline', 'isis'),
		'id' => 'recentdesc1',
...
$options[] = array( "name" => __('Number of Slides', 'isis'),
	...
	$options[] = array(
		'name' => __('Using the Slider', 'isis'),
		'desc' => __('This Slider supports upto 5 Images. To show only 3 Slides in the slider, upload only 3 images. Leave the rest Blank. For best results, upload images of size 1000x500px.upload every slider image in same size.<b>Upgrade to Isis PRO for unlimited slider and customs slider</b>', 'isis'),
		'type' => 'info');

	$options[] = array(
		'name' => __('Slider Image 1', 'isis'),
		'desc' => __('First Slide', 'isis'),
		'id' => 'slide1',
		'class' => '',
		"std" =>'',
	...
	$options[] = array(
		'name' => __('Slider Image 2', 'isis'),
		'desc' => __('Second Slide', 'isis'),
		'class' => '',
		'id' => 'slide2',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Slider Image 3', 'isis'),
		'desc' => __('Third Slide', 'isis'),
		'id' => 'slide3',
		'class' => '',
		'type' => 'upload');	
	...
	$options[] = array(
		'name' => __('Slider Image 4', 'isis'),
		'desc' => __('Fourth Slide', 'isis'),
		'id' => 'slide4',
		'class' => '',
		'type' => 'upload');	
	...
	$options[] = array(
		'name' => __('Slider Image 5', 'isis'),
		'desc' => __('Fifth Slide', 'isis'),
		'id' => 'slide5',
		'class' => '',
		'type' => 'upload');	
	...
	$options[] = array(
		...
		'desc' => __('<b>Upgrade to Isis PRO for more option </b>', 'isis'),
		'type' => 'info');					
