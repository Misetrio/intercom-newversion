		...
		<div class="container">
			...
			<div class="container-fluid">
				...
				<div id="header_nav_container">
					...
					<div class="row-fluid">
<!--<div class="span4">
<img src="/imagaes/intercom.png"
</div>-->
						<div class="span4">
							<!--<?php do_action( 'cyberchimps_header' ); ?>--><div id="int"><img src="/newfolder/wp-content/themes/fine/cyberchimps/lib/images/intercom.png "height:3px" >
</div>
						</div>
						<!-- span3 -->
						<div class="span8">
