...
define('MAPSVG_VERSION', '4.1.3');
define('MAPSVG_ASSET_VERSION', '4.1.3'.(MAPSVG_DEBUG?rand():''));
define('MAPSVG_JQUERY_VERSION', '9.1.2');
...
//        wp_enqueue_script('floors-list.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/floors-list-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), MAPSVG_ASSET_VERSION);
        ...
        wp_enqueue_script('select2', MAPSVG_PLUGIN_URL . 'js/select2.full.min.js', array('jquery'), '4.0',true);
...
//    check_ajax_referer('ajax_mapsvg_save-'.$_POST['data']['map_id']);
    ...
    if(isset($data['map_id']) && $data['map_id']!='new'){
        ...
        mapsvg_set_regions_table($post_id, $data['source'], $data['region_prefix']);
...
//        $t = get_option('mapsvg_google_api_key', '');
//        set_site_option();
//        $t = get_site_option('mapsvg_google_api_key');
        echo '{"ok": "1"}';
    }else{
