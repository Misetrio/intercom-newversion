    ...
    methods = {
            ...
            $(document).ready(function(){
                ...
                if(onEditMapScreen){
                    ...
                    $("#save-api-key").on('click', function() {
                        ...
                        if(key && key.length){
                            $.post(ajaxurl, {action: 'mapsvg_save_google_api_key',key: key}).done(function(data){
        ...
        showGoogleMapDownloader: function(){
            ...
            if(!_this.gmloaded){
                ...
                _data.googleMapsScript.src = 'https://maps.googleapis.com/maps/api/js?key='+_this.gmapikey+'&v=3.31';//+'&callback=initMap';
